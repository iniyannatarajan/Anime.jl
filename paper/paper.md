...
In radio astronomy parlance, "calibration" removes atmospheric and instrumental effects from the data while "imaging" reconstructs the sky brightness distribution from the data. 
